...
public class OpenRGBMode {
    ...
    private io.gitlab.mguimard.openrgb.entity.ColorMode colorMode;
    ...
    public OpenRGBMode(String name, int value, int flags, int speedMin, int speedMax,
                       int colorMin, int colorMax, int speed, ModeDirection direction, io.gitlab.mguimard.openrgb.entity.ColorMode colorMode,
                       List<io.gitlab.mguimard.openrgb.entity.OpenRGBColor> colors) {
        this.name = name;
        this.value = value;
        this.flags = flags;
    ...
    public io.gitlab.mguimard.openrgb.entity.ColorMode getColorMode() {
        return colorMode;
    }
